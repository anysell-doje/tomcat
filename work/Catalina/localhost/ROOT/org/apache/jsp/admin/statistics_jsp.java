 ...
 * Generated at: 2024-06-12 03:59:33 UTC
...
e.printStackTrace();
    ...
    try {
        String sqlQuery = "SELECT " +
                ...
                "ROUND(SUM(CASE WHEN hotel_reservation_status != 3 AND travel_reservation_status != 3 THEN hotel_price ELSE 0 END), 2) AS total_price, " +
        ...
        sqlQuery = "SELECT " +
                ...
                "ROUND(SUM(CASE WHEN a.hotel_reservation_status != 3 AND a.travel_reservation_status != 3 THEN a.hotel_price ELSE 0 END), 2) AS total_price, " +
