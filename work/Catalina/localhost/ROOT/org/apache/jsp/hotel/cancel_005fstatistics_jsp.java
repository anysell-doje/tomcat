 ...
 * Generated at: 2024-05-29 23:58:52 UTC
...
e.printStackTrace();
    ...
    try {
        // hotel
        String sqlQuery = "SELECT a.reservation_id, b.hotel_name, a.cancel_date FROM inquiry_info_list a "
                        + "INNER JOIN hotel_info_list b ON a.hotel_id = b.hotel_id "
                        + "WHERE (travel_reservation_status = 3 or hotel_reservation_status = 3) AND cancel_date BETWEEN ? AND ?";
        ...
        sqlQuery = "SELECT COUNT(*) AS total_count "
                 ...
                 + "INNER JOIN hotel_info_list b ON a.hotel_id = b.hotel_id "
                 + "WHERE (travel_reservation_status = 3 or hotel_reservation_status = 2) "
