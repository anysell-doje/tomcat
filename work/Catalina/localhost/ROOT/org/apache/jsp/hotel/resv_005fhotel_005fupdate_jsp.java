 ...
 * Generated at: 2024-05-22 02:31:22 UTC
...
public final class resv_005fhotel_005fupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
e.printStackTrace();
    ...
    try {
        ...
        String checkQuery = "SELECT travel_reservation_status FROM inquiry_info_list WHERE reservation_id = ? and travel_reservation_status in('1','2')";
	...
	if(checkResult.next()){
        ...
        if (canUpdate) {
            ...
            String sqlQuery = "UPDATE inquiry_info_list SET hotel_reservation_status = '3' WHERE reservation_id = ?";
