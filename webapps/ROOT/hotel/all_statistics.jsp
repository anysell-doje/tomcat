...
<%
    ...
    try {
        String sqlQuery = "SELECT " +
                ...
                "FORMAT(ROUND(COALESCE(SUM(CASE WHEN hotel_reservation_status != 3 AND travel_reservation_status != 3 THEN hotel_price ELSE 0 END), 0), 2), 'N2') AS total_price, " +
        ...
        sqlQuery = "SELECT " +
                ...
                "FORMAT(ROUND(COALESCE(SUM(CASE WHEN a.hotel_reservation_status != 3 AND a.travel_reservation_status != 3 THEN a.hotel_price ELSE 0 END), 0), 2), 'N2') AS total_price, " +
