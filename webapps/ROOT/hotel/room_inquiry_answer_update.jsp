...
<%
    ...
    try {
        ...
        if (border_id_param != null && !border_id_param.isEmpty()) {
            ...
            String sqlQuery = "UPDATE room_inquiry_list SET inquiry_answer = ? WHERE border_id = ?";
            ps = conn.prepareStatement(sqlQuery);
            ps.setString(1, request.getParameter("inquiry_answer"));
            ps.setInt(2, border_id);
            ...
            jsonResponse.put("success", false);
            jsonResponse.put("error", "inquiry_answer param null");
        }
    } catch (Exception e) {
        jsonResponse.put("success", false);
