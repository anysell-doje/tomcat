...
<%
    ...
    try {
        ...
        String sqlQuery = "SELECT " +
                          ...
                          "AND a.check_out_date BETWEEN ? AND ? " +
        ...
        while (rs.next()) {
            ...
            used.put("hotel_name", rs.getString("hotel_name"));
        ...
        // Counting total
        sqlQuery = "SELECT COUNT(room_count) AS total_count " +
                   "FROM inquiry_info_list a " +
                   "INNER JOIN hotel_info_list b ON a.hotel_id = b.hotel_id " +
                   "WHERE travel_reservation_status = 2 AND hotel_reservation_status = 2 " +
                   "AND a.check_out_date BETWEEN ? AND ?";
        ps = conn.prepareStatement(sqlQuery);
        ps.setString(1, from_date);
        ps.setString(2, to_date);
