    ...
    try {
      ...
      "COUNT(CASE WHEN hotel_reservation_status = 2 AND travel_reservation_status = 2 THEN 1 ELSE NULL END) AS confirmed_reservations, " +
        ...
        sqlQuery = "SELECT " +
                ...
                "COUNT(CASE WHEN hotel_reservation_status != 3 AND travel_reservation_status != 3 AND NOT (hotel_reservation_status = 2 AND travel_reservation_status = 2) THEN 1 ELSE NULL END) AS active_reservations, " +                "COUNT(a.reservation_id) AS total_reservations, " +
