...
<%
    ...
    try {
        ...
        if (border_id_param != null && !border_id_param.isEmpty()) {
            ...
            String sqlQuery = "UPDATE room_inquiry_list SET inquiry_title = ?, inquiry_content = ? WHERE border_id = ?";
            ps = conn.prepareStatement(sqlQuery);
            ps.setString(1, request.getParameter("inquiry_title"));
            ps.setString(2, request.getParameter("inquiry_content"));
            ps.setInt(3, border_id);
